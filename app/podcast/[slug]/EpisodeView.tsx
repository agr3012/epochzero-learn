...
export default function EpisodeView({ ep, prev, next }: Props) {
  ...
  return (
    <div className="container py-12 lg:py-16">
      ...
      {/* ── Single constrained box — matches all other pages ──────── */}
      <div className="max-w-4xl">

        {/* Cover image */}
        {ep.cover_image && (
          <div className="relative w-full aspect-[16/7] mb-8 overflow-hidden border border-navy-700">
            <Image
              src={ep.cover_image}
        ...
        <div className="mb-12">
          ...
          {lines.length > 0 ? (
            <>
              ...
              {/* Gold scrollbar — cannot be done in Tailwind, use scoped style */}
              <style>{`
