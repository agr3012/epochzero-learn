...
-- instagram_url included as '' to satisfy any remaining NOT NULL constraint
insert into public.reels
  (instagram_url, youtube_id, title, description, domain, topic_slug, duration_seconds, order_index, is_published)
values
